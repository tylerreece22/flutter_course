...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Flutter Course Home Page'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _itemTapped(int currentIndex) {
    setState(() {
      _selectedBottomBarIndex = currentIndex;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed: () {print("Adding a contact");},
          )
        ],
      ),
      body: Center(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        BottomNavigationBarItem(icon: Icon(Icons.shop), title: Text("Merch")),
